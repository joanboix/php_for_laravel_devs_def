                ...
                <div class="flex w-full items-center justify-between space-x-6 p-6">
                    <div class="flex-1 truncate">
                        <div class="flex items-center space-x-3">
                            <h3 class="truncate text-sm font-medium text-gray-900">{{ $usuari->name }}  {{ $usuari->surname }}</h3>
                            <span
                        ...
                        <p class="mt-1 truncate text-sm text-gray-500">{{ $usuari->job }}</p>
                    </div>
                ...
                <div>
                    <div class="-mt-px flex divide-x divide-gray-200">
                        <div
                            ...
                            <span class="ml-3">{{ $usuari->mail }}</span>
                            </a>
                        </div>
                        <div
